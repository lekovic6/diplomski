...
guestRouter.route('/registerUser').post((req, res) => new guest_controller_1.GuestController().registerUser(req, res));
...
guestRouter.route('/loginAdmin').post((req, res) => new guest_controller_1.GuestController().loginAdmin(req, res));
